...
const CmtProgressBar = ({
  ...
  useEffect(
    () => {
      const [
        ...
        pointerColorValue
      ] = getFillBarStyleAndPointerColors(containedColor, gradientDirection);
      setFillBarStyle({
        ...fillBarStyle,
        ...newFillBarStyleValue
      });
  ...
  return (
    <Box className={clsx(classes.root, "CmtProgressBar-root")} {...restProps}>
      ...
      {topPositions.includes(valuePos) && (
        <Box mb={2}>{renderContent("div")}</Box>
      )}
      ...
      <div className={classes.flexRoot}>
        ...
        {onlyContained ? (
          ...
          <div
            ...
            style={{backgroundColor: emptyColor, flex: 1}}
          >
            <div
              className={clsx(classes.fillStyle, "Cmt-fill-progress")}
              style={fillBarStyle}
      ...
      {bottomPositions.includes(valuePos) && (
        <Box mt={2}>{renderContent("div")}</Box>
      )}
